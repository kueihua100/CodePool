...
AssertionResult FilterTests::openFilterInDemux(DemuxFilterType type, uint32_t bufferSize) {
    Result status;
    EXPECT_TRUE_PTR(mDemux);// << "Test with openDemux first.";
...
AssertionResult FilterTests::getNewlyOpenedFilterId(uint32_t& filterId) {
    Result status;
    EXPECT_TRUE_PTR(mDemux);// << "Test with openDemux first.";
    EXPECT_TRUE_PTR(mFilter);// << "Test with openFilterInDemux first.";
    EXPECT_TRUE_PTR(mFilterCallback);// << "Test with openFilterInDemux first.";
...
AssertionResult FilterTests::configFilter(DemuxFilterSettings setting, uint32_t filterId) {
    Result status;
    EXPECT_TRUE_PTR(mFilters[filterId]);// << "Test with getNewlyOpenedFilterId first.";
...
AssertionResult FilterTests::getFilterMQDescriptor(uint32_t filterId) {
    Result status;
    EXPECT_TRUE_PTR(mFilters[filterId]);// << "Test with getNewlyOpenedFilterId first.";
    EXPECT_TRUE_PTR(mFilterCallbacks[filterId]);// << "Test with getNewlyOpenedFilterId first.";
