...
AssertionResult DvrTests::getDvrPlaybackMQDescriptor() {
    Result status;
    EXPECT_TRUE_PTR(mDemux);// << "Test with openDemux first.";
    EXPECT_TRUE_PTR(mDvrPlayback);// << "Test with openDvr first.";
...
AssertionResult DvrTests::getDvrRecordMQDescriptor() {
    Result status;
    EXPECT_TRUE_PTR(mDemux);// << "Test with openDemux first.";
    EXPECT_TRUE_PTR(mDvrRecord);// << "Test with openDvr first.";
...
void DvrTests::closeDvrPlayback() {
    ASSERT_TRUE_PTR(mDemux);
    ASSERT_TRUE_PTR(mDvrPlayback);
